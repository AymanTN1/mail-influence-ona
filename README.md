...
* **⚡ Algorithmes Haute Performance & Optimisations SIMD / C11 :**
  * **PageRank Ultra-Rapide (Power Iteration & Early Stopping $\epsilon=10^{-6}$) :** Calcul du PageRank vectorisé en **0.12 milliseconde** pour 2 500 arêtes.
